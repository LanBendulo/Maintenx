...
-- =============================================
-- STEP 3: Create Asset Status History table
-- =============================================
PRINT '';
...
PRINT '';
PRINT 'Next Steps:';
PRINT '  1. Test work order creation (should work without errors)';
PRINT '  2. Verify asset status transitions';
PRINT '  3. Check AssetStatusHistory audit trail';
PRINT '';
